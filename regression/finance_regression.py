...
features_list = ["bonus", "salary"] #for regressing against salary
...
#reg.fit(feature_test, target_test) #If I want to plot another regression line with the outlier removed
